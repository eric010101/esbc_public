...
// Create page object
$phone_basic_edit = new phone_basic_edit();

// Run the page
$phone_basic_edit->run();
...
var fphone_basicedit = currentForm = new ew.Form("fphone_basicedit", "edit");

// Validate form
fphone_basicedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($phone_basic_edit->imei->Required) { ?>
		...
		<?php } ?>
		<?php if ($phone_basic_edit->phone_name->Required) { ?>
		...
		<?php } ?>
		<?php if ($phone_basic_edit->date_add->Required) { ?>
		...
		<?php if ($phone_basic_edit->app_version->Required) { ?>
		...
		<?php } ?>
		<?php if ($phone_basic_edit->phone_num->Required) { ?>
		...
		<?php } ?>
		<?php if ($phone_basic_edit->phone_wifi_mac->Required) { ?>
		...
		<?php } ?>
		<?php if ($phone_basic_edit->active->Required) { ?>
		...
		<?php if ($phone_basic_edit->app_name->Required) { ?>
		...
		<?php } ?>
		<?php if ($phone_basic_edit->RTLindex->Required) { ?>
			elm = this.getElements("x" + infix + "_RTLindex");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $phone_basic->RTLindex->caption(), $phone_basic->RTLindex->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fphone_basicedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fphone_basicedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $phone_basic_edit->showPageHeader(); ?>
<?php
$phone_basic_edit->showMessage();
?>
<form name="fphone_basicedit" id="fphone_basicedit" class="<?php echo $phone_basic_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($phone_basic_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $phone_basic_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="phone_basic">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$phone_basic_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($phone_basic->imei->Visible) { // imei ?>
	<div id="r_imei" class="form-group row">
		<label id="elh_phone_basic_imei" for="x_imei" class="<?php echo $phone_basic_edit->LeftColumnClass ?>"><?php echo $phone_basic->imei->caption() ?><?php echo ($phone_basic->imei->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $phone_basic_edit->RightColumnClass ?>"><div<?php echo $phone_basic->imei->cellAttributes() ?>>
...
<?php if ($phone_basic->phone_name->Visible) { // phone_name ?>
	<div id="r_phone_name" class="form-group row">
		<label id="elh_phone_basic_phone_name" for="x_phone_name" class="<?php echo $phone_basic_edit->LeftColumnClass ?>"><?php echo $phone_basic->phone_name->caption() ?><?php echo ($phone_basic->phone_name->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $phone_basic_edit->RightColumnClass ?>"><div<?php echo $phone_basic->phone_name->cellAttributes() ?>>
...
<?php if ($phone_basic->date_add->Visible) { // date_add ?>
	<div id="r_date_add" class="form-group row">
		<label id="elh_phone_basic_date_add" for="x_date_add" class="<?php echo $phone_basic_edit->LeftColumnClass ?>"><?php echo $phone_basic->date_add->caption() ?><?php echo ($phone_basic->date_add->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $phone_basic_edit->RightColumnClass ?>"><div<?php echo $phone_basic->date_add->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fphone_basicedit", "x_date_add", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($phone_basic->app_version->Visible) { // app_version ?>
	<div id="r_app_version" class="form-group row">
		<label id="elh_phone_basic_app_version" for="x_app_version" class="<?php echo $phone_basic_edit->LeftColumnClass ?>"><?php echo $phone_basic->app_version->caption() ?><?php echo ($phone_basic->app_version->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $phone_basic_edit->RightColumnClass ?>"><div<?php echo $phone_basic->app_version->cellAttributes() ?>>
...
<?php if ($phone_basic->phone_num->Visible) { // phone_num ?>
	<div id="r_phone_num" class="form-group row">
		<label id="elh_phone_basic_phone_num" for="x_phone_num" class="<?php echo $phone_basic_edit->LeftColumnClass ?>"><?php echo $phone_basic->phone_num->caption() ?><?php echo ($phone_basic->phone_num->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $phone_basic_edit->RightColumnClass ?>"><div<?php echo $phone_basic->phone_num->cellAttributes() ?>>
...
<?php if ($phone_basic->phone_wifi_mac->Visible) { // phone_wifi_mac ?>
	<div id="r_phone_wifi_mac" class="form-group row">
		<label id="elh_phone_basic_phone_wifi_mac" for="x_phone_wifi_mac" class="<?php echo $phone_basic_edit->LeftColumnClass ?>"><?php echo $phone_basic->phone_wifi_mac->caption() ?><?php echo ($phone_basic->phone_wifi_mac->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $phone_basic_edit->RightColumnClass ?>"><div<?php echo $phone_basic->phone_wifi_mac->cellAttributes() ?>>
...
<?php if ($phone_basic->active->Visible) { // active ?>
	<div id="r_active" class="form-group row">
		<label id="elh_phone_basic_active" for="x_active" class="<?php echo $phone_basic_edit->LeftColumnClass ?>"><?php echo $phone_basic->active->caption() ?><?php echo ($phone_basic->active->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $phone_basic_edit->RightColumnClass ?>"><div<?php echo $phone_basic->active->cellAttributes() ?>>
...
<?php if ($phone_basic->app_name->Visible) { // app_name ?>
	<div id="r_app_name" class="form-group row">
		<label id="elh_phone_basic_app_name" for="x_app_name" class="<?php echo $phone_basic_edit->LeftColumnClass ?>"><?php echo $phone_basic->app_name->caption() ?><?php echo ($phone_basic->app_name->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $phone_basic_edit->RightColumnClass ?>"><div<?php echo $phone_basic->app_name->cellAttributes() ?>>
...
<?php if ($phone_basic->RTLindex->Visible) { // RTLindex ?>
	<div id="r_RTLindex" class="form-group row">
		<label id="elh_phone_basic_RTLindex" class="<?php echo $phone_basic_edit->LeftColumnClass ?>"><?php echo $phone_basic->RTLindex->caption() ?><?php echo ($phone_basic->RTLindex->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $phone_basic_edit->RightColumnClass ?>"><div<?php echo $phone_basic->RTLindex->cellAttributes() ?>>
<span id="el_phone_basic_RTLindex">
<span<?php echo $phone_basic->RTLindex->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($phone_basic->RTLindex->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="phone_basic" data-field="x_RTLindex" name="x_RTLindex" id="x_RTLindex" value="<?php echo HtmlEncode($phone_basic->RTLindex->CurrentValue) ?>">
<?php echo $phone_basic->RTLindex->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<?php if (!$phone_basic_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $phone_basic_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $phone_basic_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$phone_basic_edit->showPageFooter();
if (DEBUG_ENABLED)
