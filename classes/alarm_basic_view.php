...
// Page class
//
class alarm_basic_view extends alarm_basic
{
	...
	// Page object name
	public $PageObjName = "alarm_basic_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->terminate("alarm_basiclist.php"); // Return to list page
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$returnUrl = "alarm_basiclist.php"; // No matching record, return to list
					} else {
			...
			$returnUrl = "alarm_basiclist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
