...
// Page class
//
class phone_basic_delete extends phone_basic
{
	...
	// Page object name
	public $PageObjName = "phone_basic_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("phone_basiclist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("phone_basiclist.php"); // Return to list
			}
		}
	}
