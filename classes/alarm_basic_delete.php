...
// Page class
//
class alarm_basic_delete extends alarm_basic
{
	...
	// Page object name
	public $PageObjName = "alarm_basic_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("alarm_basiclist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("alarm_basiclist.php"); // Return to list
			}
		}
	}
