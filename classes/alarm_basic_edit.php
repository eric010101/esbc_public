...
// Page class
//
class alarm_basic_edit extends alarm_basic
{
	...
	// Page object name
	public $PageObjName = "alarm_basic_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// value_max
			$this->value_max->setDbValueDef($rsnew, $this->value_max->CurrentValue, NULL, $this->value_max->ReadOnly);

			// value_min
			$this->value_min->setDbValueDef($rsnew, $this->value_min->CurrentValue, NULL, $this->value_min->ReadOnly);

			// delaytime
			$this->delaytime->setDbValueDef($rsnew, $this->delaytime->CurrentValue, NULL, $this->delaytime->ReadOnly);

			// date_add
			$this->date_add->setDbValueDef($rsnew, UnFormatDateTime($this->date_add->CurrentValue, 0), NULL, $this->date_add->ReadOnly);

			// date_modified
			$this->date_modified->setDbValueDef($rsnew, UnFormatDateTime($this->date_modified->CurrentValue, 0), NULL, $this->date_modified->ReadOnly);

			// user_add
			$this->user_add->setDbValueDef($rsnew, $this->user_add->CurrentValue, NULL, $this->user_add->ReadOnly);

			// user_modified
			$this->user_modified->setDbValueDef($rsnew, $this->user_modified->CurrentValue, NULL, $this->user_modified->ReadOnly);

			// email_receipt
			$this->email_receipt->setDbValueDef($rsnew, $this->email_receipt->CurrentValue, NULL, $this->email_receipt->ReadOnly);

			// email_subject
			$this->email_subject->setDbValueDef($rsnew, $this->email_subject->CurrentValue, NULL, $this->email_subject->ReadOnly);

			// email_body
			$this->email_body->setDbValueDef($rsnew, $this->email_body->CurrentValue, NULL, $this->email_body->ReadOnly);

			// email_attach
			$this->email_attach->setDbValueDef($rsnew, $this->email_attach->CurrentValue, NULL, $this->email_attach->ReadOnly);

			// sms_num
			$this->sms_num->setDbValueDef($rsnew, $this->sms_num->CurrentValue, NULL, $this->sms_num->ReadOnly);

			// sms_body
			$this->sms_body->setDbValueDef($rsnew, $this->sms_body->CurrentValue, NULL, $this->sms_body->ReadOnly);

			// alarm_subscriber
			$this->alarm_subscriber->setDbValueDef($rsnew, $this->alarm_subscriber->CurrentValue, NULL, $this->alarm_subscriber->ReadOnly);

			// sms_active
			$this->sms_active->setDbValueDef($rsnew, $this->sms_active->CurrentValue, 0, $this->sms_active->ReadOnly);

			// email_active
			$this->email_active->setDbValueDef($rsnew, $this->email_active->CurrentValue, 0, $this->email_active->ReadOnly);
