...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "esbc_public_20181122"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{1450346A-D3E5-42C5-B2E0-BD489F2A0BDC}"); // Project ID (GUID)
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'VKO0kv7g5g8J1eOB'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/esbc_public_20181122.css"); // Project stylesheet file name
