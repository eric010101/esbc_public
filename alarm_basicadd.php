...
// Create page object
$alarm_basic_add = new alarm_basic_add();
...
var falarm_basicadd = currentForm = new ew.Form("falarm_basicadd", "add");

// Validate form
falarm_basicadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($alarm_basic_add->sensor_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($alarm_basic_add->value_max->Required) { ?>
		...
		<?php if ($alarm_basic_add->value_min->Required) { ?>
		...
		<?php if ($alarm_basic_add->delaytime->Required) { ?>
		...
		<?php if ($alarm_basic_add->date_add->Required) { ?>
		...
		<?php if ($alarm_basic_add->date_modified->Required) { ?>
		...
		<?php if ($alarm_basic_add->user_add->Required) { ?>
		...
		<?php if ($alarm_basic_add->user_modified->Required) { ?>
		...
		<?php if ($alarm_basic_add->email_receipt->Required) { ?>
		...
		<?php } ?>
		<?php if ($alarm_basic_add->email_subject->Required) { ?>
		...
		<?php } ?>
		<?php if ($alarm_basic_add->email_body->Required) { ?>
		...
		<?php } ?>
		<?php if ($alarm_basic_add->email_attach->Required) { ?>
		...
		<?php } ?>
		<?php if ($alarm_basic_add->sms_num->Required) { ?>
		...
		<?php } ?>
		<?php if ($alarm_basic_add->sms_body->Required) { ?>
		...
		<?php } ?>
		<?php if ($alarm_basic_add->alarm_subscriber->Required) { ?>
		...
		<?php } ?>
		<?php if ($alarm_basic_add->sms_active->Required) { ?>
		...
		<?php if ($alarm_basic_add->email_active->Required) { ?>
...
falarm_basicadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
falarm_basicadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $alarm_basic_add->showPageHeader(); ?>
<?php
$alarm_basic_add->showMessage();
?>
<form name="falarm_basicadd" id="falarm_basicadd" class="<?php echo $alarm_basic_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($alarm_basic_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $alarm_basic_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="alarm_basic">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$alarm_basic_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($alarm_basic->sensor_id->Visible) { // sensor_id ?>
	<div id="r_sensor_id" class="form-group row">
		<label id="elh_alarm_basic_sensor_id" for="x_sensor_id" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->sensor_id->caption() ?><?php echo ($alarm_basic->sensor_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->sensor_id->cellAttributes() ?>>
...
<?php if ($alarm_basic->value_max->Visible) { // value_max ?>
	<div id="r_value_max" class="form-group row">
		<label id="elh_alarm_basic_value_max" for="x_value_max" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->value_max->caption() ?><?php echo ($alarm_basic->value_max->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->value_max->cellAttributes() ?>>
...
<?php if ($alarm_basic->value_min->Visible) { // value_min ?>
	<div id="r_value_min" class="form-group row">
		<label id="elh_alarm_basic_value_min" for="x_value_min" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->value_min->caption() ?><?php echo ($alarm_basic->value_min->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->value_min->cellAttributes() ?>>
...
<?php if ($alarm_basic->delaytime->Visible) { // delaytime ?>
	<div id="r_delaytime" class="form-group row">
		<label id="elh_alarm_basic_delaytime" for="x_delaytime" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->delaytime->caption() ?><?php echo ($alarm_basic->delaytime->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->delaytime->cellAttributes() ?>>
...
<?php if ($alarm_basic->date_add->Visible) { // date_add ?>
	<div id="r_date_add" class="form-group row">
		<label id="elh_alarm_basic_date_add" for="x_date_add" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->date_add->caption() ?><?php echo ($alarm_basic->date_add->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->date_add->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("falarm_basicadd", "x_date_add", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($alarm_basic->date_modified->Visible) { // date_modified ?>
	<div id="r_date_modified" class="form-group row">
		<label id="elh_alarm_basic_date_modified" for="x_date_modified" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->date_modified->caption() ?><?php echo ($alarm_basic->date_modified->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->date_modified->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("falarm_basicadd", "x_date_modified", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($alarm_basic->user_add->Visible) { // user_add ?>
	<div id="r_user_add" class="form-group row">
		<label id="elh_alarm_basic_user_add" for="x_user_add" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->user_add->caption() ?><?php echo ($alarm_basic->user_add->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->user_add->cellAttributes() ?>>
...
<?php if ($alarm_basic->user_modified->Visible) { // user_modified ?>
	<div id="r_user_modified" class="form-group row">
		<label id="elh_alarm_basic_user_modified" for="x_user_modified" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->user_modified->caption() ?><?php echo ($alarm_basic->user_modified->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->user_modified->cellAttributes() ?>>
...
<?php if ($alarm_basic->email_receipt->Visible) { // email_receipt ?>
	<div id="r_email_receipt" class="form-group row">
		<label id="elh_alarm_basic_email_receipt" for="x_email_receipt" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->email_receipt->caption() ?><?php echo ($alarm_basic->email_receipt->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->email_receipt->cellAttributes() ?>>
...
<?php if ($alarm_basic->email_subject->Visible) { // email_subject ?>
	<div id="r_email_subject" class="form-group row">
		<label id="elh_alarm_basic_email_subject" for="x_email_subject" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->email_subject->caption() ?><?php echo ($alarm_basic->email_subject->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->email_subject->cellAttributes() ?>>
...
<?php if ($alarm_basic->email_body->Visible) { // email_body ?>
	<div id="r_email_body" class="form-group row">
		<label id="elh_alarm_basic_email_body" for="x_email_body" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->email_body->caption() ?><?php echo ($alarm_basic->email_body->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->email_body->cellAttributes() ?>>
...
<?php if ($alarm_basic->email_attach->Visible) { // email_attach ?>
	<div id="r_email_attach" class="form-group row">
		<label id="elh_alarm_basic_email_attach" for="x_email_attach" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->email_attach->caption() ?><?php echo ($alarm_basic->email_attach->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->email_attach->cellAttributes() ?>>
...
<?php if ($alarm_basic->sms_num->Visible) { // sms_num ?>
	<div id="r_sms_num" class="form-group row">
		<label id="elh_alarm_basic_sms_num" for="x_sms_num" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->sms_num->caption() ?><?php echo ($alarm_basic->sms_num->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->sms_num->cellAttributes() ?>>
...
<?php if ($alarm_basic->sms_body->Visible) { // sms_body ?>
	<div id="r_sms_body" class="form-group row">
		<label id="elh_alarm_basic_sms_body" for="x_sms_body" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->sms_body->caption() ?><?php echo ($alarm_basic->sms_body->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->sms_body->cellAttributes() ?>>
...
<?php if ($alarm_basic->alarm_subscriber->Visible) { // alarm_subscriber ?>
	<div id="r_alarm_subscriber" class="form-group row">
		<label id="elh_alarm_basic_alarm_subscriber" for="x_alarm_subscriber" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->alarm_subscriber->caption() ?><?php echo ($alarm_basic->alarm_subscriber->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->alarm_subscriber->cellAttributes() ?>>
...
<?php if ($alarm_basic->sms_active->Visible) { // sms_active ?>
	<div id="r_sms_active" class="form-group row">
		<label id="elh_alarm_basic_sms_active" for="x_sms_active" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->sms_active->caption() ?><?php echo ($alarm_basic->sms_active->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->sms_active->cellAttributes() ?>>
...
<?php if ($alarm_basic->email_active->Visible) { // email_active ?>
	<div id="r_email_active" class="form-group row">
		<label id="elh_alarm_basic_email_active" for="x_email_active" class="<?php echo $alarm_basic_add->LeftColumnClass ?>"><?php echo $alarm_basic->email_active->caption() ?><?php echo ($alarm_basic->email_active->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $alarm_basic_add->RightColumnClass ?>"><div<?php echo $alarm_basic->email_active->cellAttributes() ?>>
...
<?php if (!$alarm_basic_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $alarm_basic_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $alarm_basic_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$alarm_basic_add->showPageFooter();
if (DEBUG_ENABLED)
